...
SECRET_KEY = 'django-insecure-mlb&&e5^)(_y13h1753c8=aw%$ah4qo0a1ds88%47r(!w_)b$%'
...
STATIC_URL = "/static/"
# STATIC_ROOT = BASE_DIR / "static/" # if run on application server
